...
$hide = optional_param('hide', NULL, PARAM_RAW);
$show = optional_param('show', NULL, PARAM_RAW);
$bids = explode(',', optional_param('bids', array(), PARAM_RAW));

// Get Badges Ids in the POST parameters
foreach ($_POST as $par => $value) {
    if (preg_match('/^badgeid\_(\d+)$/', $pam)) {
